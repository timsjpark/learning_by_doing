...
plu_noun2 = 'another plural noun'
game = 'a game'
verb_ing = "a verb ending in 'ing'"
verb_ing2 = "another verb ending in 'ing'"
plant = 'a plant'
...
or play #{get_word(game)} or go hunting for #{get_word(plu_noun2)}. I like
to spend my time #{get_word(verb_ing)} or #{get_word(verb_ing2)}.
When parents go on a vacation, they spend their time eating
three #{get_word(plu_noun2)} a day, and fathers play golf, and mothers
sit around #{get_word(verb_ing2)}. Last summer, my little brother
fell in a/an #{get_word(noun2)} and got poison #{get_word(plant)} all
over his #{get_word(body)}. My family is going to go to (the)
#{get_word(place)}, and I will practice #{get_word(verb_ing2)}. Parents
